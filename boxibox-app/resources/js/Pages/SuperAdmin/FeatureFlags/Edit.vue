...
const form = useForm({
    ...
    is_enabled: props.flag.is_enabled,
    enabled_for_tenants: props.flag.enabled_for_tenants || [],
    enabled_for_plans: props.flag.enabled_for_plans || [],
})

const submit = () => {
    form.put(route('superadmin.feature-flags.update', props.flag.id))
}
</script>

<template>
    <Head :title="`Modifier - ${flag.name}`" />

    <SuperAdminLayout :title="`Modifier - ${flag.name}`">
        <div class="max-w-2xl mx-auto space-y-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-white">Modifier le Feature Flag</h1>
                    <p class="mt-1 text-sm text-gray-400 font-mono">{{ flag.key }}</p>
                </div>
            </div>
                ...
                <div class="bg-gray-800 rounded-xl border border-gray-700 p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            />
                            <p class="mt-1 text-sm text-gray-500">Attention: modifier la clé peut casser le code existant</p>
