...
const submit = () => {
    form.post(route('superadmin.email-templates.store'))
}
</script>

<template>
    <Head title="Nouveau Template Email" />

    <SuperAdminLayout title="Nouveau Template Email">
        <div class="max-w-4xl mx-auto space-y-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-white">Nouveau Template Email</h1>
                    <p class="mt-1 text-sm text-gray-400">Créez un nouveau modèle d'email</p>
                </div>
            </div>
                ...
                <div class="bg-gray-800 rounded-xl border border-gray-700 p-6">
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input
                                ...
                                placeholder="Bienvenue nouvel utilisateur"
                            />
                    ...
                    <div class="mt-4">
                        ...
                        <input
                            ...
                            type="text"
                            class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-purple-500 focus:border-purple-500"
                            placeholder="Bienvenue sur {{app_name}}, {{user_name}} !"
                        />
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="<html><body>Bonjour {{user_name}},...</body></html>"
                            ></textarea>
