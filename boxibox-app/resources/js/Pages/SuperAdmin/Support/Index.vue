...
const applyFilters = () => {
    router.get(route('superadmin.support.index'), {
        ...
        <div class="py-6">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Support Tenants</h1>
                        <p class="text-gray-600">Gerez le support technique avec vos tenants</p>
                    </div>
                    <Link
                        :href="route('superadmin.support.create')"
                            ...
                            <div class="flex items-start justify-between">
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-sm text-gray-500 mt-1">
                                        <span class="font-medium text-primary-600">{{ ticket.tenant?.name || 'Tenant inconnu' }}</span>
                                    </p>
