...
const submit = () => {
    form.post(route('superadmin.modules.store'))
}
...
<template>
    ...
    <SuperAdminLayout title="Nouveau Module">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="mb-6">
                ...
                <h1 class="mt-2 text-2xl font-bold text-white">Creer un nouveau module</h1>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                <div class="bg-gray-800 rounded-xl border border-gray-700 p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500">Le code sera utilise pour identifier ce module</p>
                        </div>
                    </div>
                ...
                <div class="flex items-center justify-end gap-3">
                    ...
                    >
                        {{ form.processing ? 'Creation...' : 'Creer le module' }}
                    </button>
                </div>
            </form>
        </div>
