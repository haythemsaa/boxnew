<template>
    <AuthenticatedLayout title="Edit Box">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-6">
                ...
                <h2 class="text-2xl font-bold text-gray-900">Edit Box</h2>
                <p class="mt-1 text-sm text-gray-600">Update box information</p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <form @submit.prevent="submit">
                    ...
                    <div class="mt-8 flex items-center justify-end space-x-3 pt-6 border-t">
                        ...
                        >
                            <span v-if="!form.processing">Update Box</span>
