...
<template>
    <AuthenticatedLayout title="Modifier Prospect">
        <div class="max-w-4xl mx-auto">
            <!-- Header -->
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">Modifier le prospect</h2>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="grid gap-4 md:grid-cols-3">
                        <div class="text-center p-4 bg-gray-50 rounded-lg">
                            <p class="text-2xl font-bold text-gray-900">{{ prospect.follow_up_count }}</p>
                            <p class="text-sm text-gray-500">Relances effectuées</p>
                        </div>
                        <div class="text-center p-4 bg-gray-50 rounded-lg">
                            <p class="text-sm font-medium text-gray-900">
                                {{ prospect.last_contact_at ? new Date(prospect.last_contact_at).toLocaleDateString('fr-FR') : 'Jamais' }}
                            </p>
                            <p class="text-sm text-gray-500">Dernier contact</p>
                        </div>
                        <div class="text-center p-4 bg-gray-50 rounded-lg">
                            <p class="text-sm font-medium text-gray-900">
