<template>
    <AuthenticatedLayout title="Create Site">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="mb-6">
                ...
                <h2 class="text-2xl font-bold text-gray-900">Create New Site</h2>
                <p class="mt-1 text-sm text-gray-600">Add a new storage location to your network</p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <form @submit.prevent="submit">
                    ...
                    <div class="mt-8 flex items-center justify-end space-x-3 pt-6 border-t">
                        ...
                        >
                            <span v-if="!form.processing">Create Site</span>
